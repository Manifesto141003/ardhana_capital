...
export const Performance = () => {
  ...
  const quarterlyData = [
    ...
    { title: 'Quarter V',  period: 'Aug – Oct 2026',      return: 10.28, benchmark: 10.28,     outperformance: 0, status: 'ongoing' },
  ];
          ...
          >
            ...
            <div className="rounded-2xl bg-[#0B0F14] border border-[#1B2A3F] p-8">
              ...
              <div className="mt-8 pt-6 border-t border-white/10 text-center">
                ...
                <p className="text-xs text-white/35 mt-2">Performa aset selama 1 <Tahun> tahun </Tahun> investasi</p>
              </div>
            </div>
          </motion.div>
        )}
