...
const MARKET_DATA = [
  ...
  { label: 'BRK.B',     value: 3.23,  hargaAwal: '~$431.69',    hargaAkhir: '~$488.13'   },
  { label: 'IHSG',      value: -24.99,  hargaAwal: '~7537.77',   hargaAkhir: '~5594.77'  },
  { label: 'BBCA',      value: -38.86, hargaAwal: '8275',    hargaAkhir: '5075'   },
  { label: 'NVDA',      value: 18.06, hargaAwal: '173.41',   hargaAkhir: '~205.10'   },
];
...
export const Performance = () => {
  ...
  const quarterlyData = [
    ...
    { title: 'Quarter III', period: 'Feb – Apr 2026',      return: 3.66, benchmark: 12.92, outperformance: 0, status: 'done'     },
    { title: 'Quarter IV',  period: 'May – Jul 2026',      return: -6.88,     benchmark: -6.88,     outperformance: 0, status: 'ongoing' },
  ...
  const yearlyData = [
    ...
    { year: '2026', return: 1.50, benchmark: 28.86, status: 'ongoing' },
  ];
